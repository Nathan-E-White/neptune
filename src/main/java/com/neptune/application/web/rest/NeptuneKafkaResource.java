...
@RestController
@RequestMapping("/api/neptune-kafka")
public class NeptuneKafkaResource {

    private final Logger log = LoggerFactory.getLogger(NeptuneKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NeptuneKafkaResource(KafkaProperties kafkaProperties) {
